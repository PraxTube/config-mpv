...
options.DeletedFilesPath = utils.join_path(os.getenv("HOME"), ".deleted_files_from_mpv")
...
mp.add_key_binding("ctrl+D", "clear_list", function() mp.osd_message("Undelete all"); del_list = {}; end)
